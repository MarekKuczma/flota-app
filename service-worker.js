...
var WERSJA_CACHE = 'flota-shell-v139';  // 23.09.2026 W-85: Kosmos wchodzi do KANONU RODZINY (Ewidencja i Asystent też go dostają). We Flocie WYGLĄD BEZ ZMIAN co do piksela (sprawdzone zrzutami przed/po) — znika tylko obejście W-50: Kosmos jest w rejestrze kanonu, jego CSS w osobnym bloku kanonu KOSMOS (identycznym w 3 appkach), niebo rysuje rysujNiebo_() z bloku kanonu. Zmiana tylko w bloku wspólnym i w miejscu dawnego wyjątku; API bez zmian (v20).  // 21.09.2026 W-50: nowa paleta SPECJALNA „Kosmos” (gwiazdy i mglawice pod appka, karty przeswiecajace przez backdrop-filter) — TYLKO we Flocie, jako nazwany wyjatek od kanonu palet; widza ja wylacznie kierowcy z „Paleta specjalna = TAK”. Wariant D wybrany przez Marka po pomiarze plynnosci na telefonie (strona probna proba-w50-2026-09-21.html). Zadnych zmian w API.  // 14.09.2026 W-67: karta „sierpien zgloszony jako zamkniety" znika po ZAMKNIECIU miesiaca i zdanie w karcie mowi to wprost („gdy Marek zamknie miesiac"), zamiast obiecywac archiwizacje. Zgloszenie Marka 14.09: zamknal i zarchiwizowal 08.2026 w obu appkach — we Flocie karta zniknela, w Ewidencji zostala. Powod byl po stronie backendu Ewidencji (`zgloszoneMiesiace_` jako jedyna funkcja nie odsiewala miesiecy zamknietych) — poprawione w API v50. Archiwizacja i tak WYMAGA wczesniejszego zamkniecia, wiec „znika przy zamknieciu" znaczy „najpozniej przy archiwizacji".   // 13.09.2026 W-45: naglowek miesiaca na liscie wpisow pokazuje ROK TYLKO wtedy, gdy inny niz biezacy („PAZDZIERNIK”, ale „GRUDZIEN 2025”) — „PAZDZIERNIK 2026” potrzebowal 353 px przy 328 px do dyspozycji i podpis „szczegoly” spadal pod nazwe miesiaca (tak samo dzis wrzesien, czerwiec i grudzien). Podsumowanie i wybierak miesiaca maja rok dalej.  // 04.09.2026 W-55: wraca umowiony tekst „jesli cos dopiszesz ALBO POPRAWISZ, zgloszenie sie cofnie” — bo od API v20 poprawka i anulowanie wpisu tez cofaja deklaracje. Stan po poprawce i po anulowaniu wraca w odpowiedzi (`stanPo`), wiec pulpit zmienia sie od razu. Wymaga API v20.  // 04.09.2026 W-56: karta „zgloszony jako zamkniety” i baner znikaja/pojawiaja sie OD RAZU po zapisie wpisu — backend v19 oddaje `stanPo` razem z odpowiedzia, wiec appka nie wola juz `status` drugim zadaniem. Rysowanie obu elementow zebrane w jednej funkcji `zastosujStanMiesiecy_`. Wymaga API v19.  // 04.09.2026 W-53/W-54: karta nad „Ostatnimi wpisami”, tytul 15 px i jedno slownictwo („Sierpien 2026 zgloszony jako zamkniety”); po zapisie wpisu leci pobierzStatus(), wiec karta znika od razu; dialog „Zamykam miesiac” i ekran „Wpis dodany” mowia, ze zgloszenie sie cofa.  // 03.09.2026 W-52b: zielona ramka + zielony ptaszek zamiast pastylki; rozwijanie pigulka 'szczegoly' jak przy wpisach.  // 03.09.2026: W-52 — karta „masz zgłoszone" zwinięta do jednej linijki i PRZENIESIONA do pulpitu (stała w <main>, więc wisiała też nad „Nowym wpisem" i „Moimi wpisami").  // 02.09.2026: W-46/W-47 — pulpit mówi, co już zgłoszone („Masz zgłoszone: lipiec i sierpień”), a w ewidencji także KTO zgłosił i czy maszyna ma opiekuna. Wymaga API v18.
