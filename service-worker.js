...
var WERSJA_CACHE = 'flota-shell-v133';  // 04.09.2026 W-53/W-54: karta nad „Ostatnimi wpisami”, tytul 15 px i jedno slownictwo („Sierpien 2026 zgloszony jako zamkniety”); po zapisie wpisu leci pobierzStatus(), wiec karta znika od razu; dialog „Zamykam miesiac” i ekran „Wpis dodany” mowia, ze zgloszenie sie cofa.  // 03.09.2026 W-52b: zielona ramka + zielony ptaszek zamiast pastylki; rozwijanie pigulka 'szczegoly' jak przy wpisach.  // 03.09.2026: W-52 — karta „masz zgłoszone" zwinięta do jednej linijki i PRZENIESIONA do pulpitu (stała w <main>, więc wisiała też nad „Nowym wpisem" i „Moimi wpisami").  // 02.09.2026: W-46/W-47 — pulpit mówi, co już zgłoszone („Masz zgłoszone: lipiec i sierpień”), a w ewidencji także KTO zgłosił i czy maszyna ma opiekuna. Wymaga API v18.
